...
@section('page-title', 'Laboratorium – Buat Rujukan')
...
<form action="{{ url('/laboratorium/request/store') }}" method="POST">
    @csrf
    ...
    <div class="card">
        <div class="card-header" style="justify-content: space-between; display: flex; align-items: center;">
            <h3 class="card-title">Pilih Jenis Pemeriksaan</h3>
            <div class="input-group" style="width: 250px;">
                <input type="text" id="pemeriksaanSearch" class="form-control form-control-sm" placeholder="Cari pemeriksaan...">
            </div>
        </div>
        ...
        <div class="card-footer" style="display:flex; justify-content: flex-end; gap: 10px; padding: 20px;">
            ...
            <button type="submit" class="btn btn-primary px-40">Kirim Rujukan Lab</button>
        </div>
    </div>
</form>
